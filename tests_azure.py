...
def main():
    ...
    hipporag = HippoRAG(save_dir=save_dir,
                        ...
                        azure_embedding_endpoint="https://123s-mann562s-eastus2.cognitiveservices.azure.com/openai/deployments/text-embedding-3-small/embeddings?api-version=2023-05-15"
                        )
